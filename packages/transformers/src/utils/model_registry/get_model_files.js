 ...
 * @param {PretrainedConfig} [options.config] Pre-loaded config; skips fetching if provided.
 * @param {string} [options.cache_dir] Custom local cache directory.
...
export function get_config(
    modelId,
    { config = undefined, cache_dir = undefined, local_files_only = false, revision = 'main' } = {},
) {
 ...
 * @param {import('../../configs.js').PretrainedConfig} [options.config] Pre-loaded model config
...
export async function get_model_files(
    modelId,
    { config = undefined, dtype: overrideDtype = undefined, device: overrideDevice = undefined, model_file_name = undefined } = {},
) {
