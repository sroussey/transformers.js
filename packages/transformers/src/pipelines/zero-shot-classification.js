    ...
    extends /** @type {new (options: TextPipelineConstructorArgs) => ZeroShotClassificationPipelineType} */ (/** @type {unknown} */ (Pipeline))
{
    ...
    constructor(options) {
        ...
        this.label2id = /** @type {Record<string, number>} */ (Object.fromEntries(
     ...
     * @param {string} [options.hypothesis_template='This example is {}.']
     * @param {boolean} [options.multi_label=false]
     */
