...
export class MaskFormerImageProcessor extends ImageProcessor {
    ...
    post_process_panoptic_segmentation(...args) {
        return post_process_panoptic_segmentation(.../** @type {Parameters<typeof post_process_panoptic_segmentation>} */ (args));
    }
    /** @type {typeof post_process_instance_segmentation} */
    post_process_instance_segmentation(...args) {
        return post_process_instance_segmentation(.../** @type {Parameters<typeof post_process_instance_segmentation>} */ (args));
    }
}
