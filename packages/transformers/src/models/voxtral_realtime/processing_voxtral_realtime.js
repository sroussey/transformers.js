...
export class VoxtralRealtimeProcessor extends Processor {
    ...
    get num_samples_first_audio_chunk() {
        const { hop_length, n_fft } = /** @type {Record<string, number>} */ (this.feature_extractor.config);
    ...
    get raw_audio_length_per_tok() {
        return AUDIO_LENGTH_PER_TOK * /** @type {number} */ (/** @type {any} */ (this.feature_extractor.config).hop_length);
    }
