 ...
 */
/** @param {Record<string, Map<string, string>>} mappings */
 ...
 * @private
 */
/** @param {number[]|number[][]|bigint[]|bigint[][]|Tensor} items */
 ...
 */
/** @param {number} modelType @param {Object} config @param {Object} [options] */
 ...
 */
/** @param {string|undefined} modelName @param {Object|null} config */
 ...
 * ```
 */
/** @param {Record<string, any>} model_inputs @param {any} [past_key_values] @param {number} [start_index] */
