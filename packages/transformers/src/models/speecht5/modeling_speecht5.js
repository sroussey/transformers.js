...
export class SpeechT5ForTextToSpeech extends SpeechT5PreTrainedModel {
     ...
     * @param {PreTrainedModel | null} [options.vocoder=null] The vocoder that converts the mel spectrogram into a speech waveform. If `null`, the output is the mel spectrogram.
    ...
    async generate_speech(
        ...
        while (true) {
            ...
            past_key_values = this.getPastKeyValues(/** @type {Record<string, Tensor>} */ (decoder_outputs), /** @type {import('../../cache_utils.js').DynamicCache} */ (past_key_values));
