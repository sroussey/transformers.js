 ...
 * @property {import('../utils/tensor.js').Tensor | null} [inputs=null] (`Tensor` of varying shape depending on the modality, *optional*):
 ...
 * @property {import('./configuration_utils.js').GenerationConfig | null} [generation_config=null] (`GenerationConfig`, *optional*):
 ...
 * @property {import('./logits_process.js').LogitsProcessorList | null} [logits_processor=null] (`LogitsProcessorList`, *optional*):
 * Custom logits processors that complement the default logits processors built from arguments and
 * generation config. If a logit processor is passed that is already created with the arguments or a
 * generation config an error is thrown. This feature is intended for advanced users.
 * @property {import('./stopping_criteria.js').StoppingCriteria|import('./stopping_criteria.js').StoppingCriteria[]|import('./stopping_criteria.js').StoppingCriteriaList|null} [stopping_criteria=null] (`StoppingCriteriaList`, *optional*):
 * Custom stopping criteria that complements the default stopping criteria built from arguments and a
 * generation config. If a stopping criteria is passed that is already created with the arguments or a
 * generation config an error is thrown. This feature is intended for advanced users.
 * @property {import('./streamers.js').BaseStreamer & import('./streamers.js').TextStreamer | null} [streamer=null] (`BaseStreamer`, *optional*):
